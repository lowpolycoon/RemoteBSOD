...
namespace RemoteBSOD.Server
{
    ...
    public class ServerSend
    {
        ...
        public static void CheckConn(int _toClient, string _msg)
        {
...
namespace RemoteBSOD.Client
{
    ...
    public class ClientSend
    {
        ...
        public static void CrashReceived()
        {
            using (Packet _packet = new Packet((int)ClientSidePackets.CrashReceived))
            {
                string pcName = System.Environment.MachineName;
                _packet.Write(pcName);
